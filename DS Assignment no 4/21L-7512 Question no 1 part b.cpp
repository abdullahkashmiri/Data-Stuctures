...
//	{
//		cout << traverse->at(i).first << "," << traverse->at(i).second << endl;// print key and value
//
//	}
//	cout << endl;
//}
...
//		stu = SBST.Search(oldroll);
//		if (stu)
//		{
//			cout << "Record found" << endl;
//			SBST.PostOrder();
//			stu = SBST.Search(newroll);
//			if (stu)
//			{
//				return false;
//			}
...
//{
//
//	StudentList <int, string>sl;
//	
//	/*sl.insertNewStudent(1, "e", "bgfb", 45, "cfds", 41.90);
//	sl.insertNewStudent(2, "ax", "bgfb", 14, "cdfs", 1.4290);
//	sl.insertNewStudent(3, "axscrsa", "bbgf", 51, "cgfb", 421.90);
//	sl.insertNewStudent(2, "asax", "bfgb", 154, "cgfb", 1.9220);
//	sl.insertNewStudent(1, "ar3rf", "bh5y", 451, "gfbc", 12424.90);
//	sl.insertNewStudent(4, "atbh", "h5b", 41, "gfbc",231.90);*/
//
//	sl.insertNewStudent(3, "a", "b", 2, "c", 1.0);
//	sl.insertNewStudent(5, "a", "b", 2, "c", 1.0);
//	sl.insertNewStudent(2, "a", "b", 2, "c", 1.0);
//	sl.insertNewStudent(2, "a", "b", 2, "c", 1.0);
//	sl.insertNewStudent(1, "a", "b", 2, "c", 1.0);
//	sl.insertNewStudent(4, "a", "b", 2, "c", 1.0);
//
//	sl.PrintAllStudents();
//	sl.deleteStudent(2);
//	sl.PrintAllStudents();
...
//	if (sl.updateStudent(4, 43, "a", "b", 1, "c", 1.90))
//	{
